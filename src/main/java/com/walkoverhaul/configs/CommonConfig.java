...
public class CommonConfig {
    ...
    public static int sprintMultiplier = 100;
    ...
    public static void loadFromConfig(Configuration config) {
        ...
        sprintMultiplier = createConfigInt(config, "General", "sprintMultiplier", "Sprint speed multiplier in percents (default - 100%)", 100);
